      ...
      case "NotPlaying":
        message.channel.send(
          new MessageEmbed()
            ...
            .setDescription(`There is no music being played in this server.`)
        );
        break;
      case "NotConnected":
        message.channel.send(
      ...
      case "VideoUnavailable":
        message.channel.send(
          new MessageEmbed()
            ...
            .setDescription(`${args[0].title} is unavailable. Skipping.`)
        );
        break;
      case "MusicStarting":
        message.channel.send(
          new MessageEmbed()
            ...
            .setDescription(`The song is starting. Please wait or retry.`)
        );
        break;
      default:
        message.channel.send(
