...
} else message.channel.send(new MessageEmbed().setAuthor("Please Choose a Valid Number.", "https://raw.githubusercontent.com/HurricanoBot/HurricanoImages/master/SetAuthorEmojis/Error.png").setDescription(`Please choose a valid number between **1** and **${tracks.length}**.`));
}};