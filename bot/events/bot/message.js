...
module.exports = {
 ...
 if (message.author.bot || message.channel.type == "dm") return; 
  ...
  .setDescription(`Hello! I'm **Hurricano™**. My prefix is \`${prefix}\`. I have a variety of commands you can use which you can view by doing \`${prefix}help\`! If you want to view information about me please do \`${prefix}botinfo\`. That's it for now, bye and have a great time!`)
  .setColor("#034ea2")
