module.exports = class BaseEvent {
    ...
    static validate(name, options) {
        ...
        if (typeof name !== "string") throw new Error("Event name is not an object.");
        if (!options.client) throw new Error("No client provided.");
        if (typeof client !== "object") throw new Error("Client is not an object.");
        if (typeof options.description !== "string") throw new Error("Event description is not a string. The event description is meant to provide what this event is meant for, etc.");
    }
    run() {
