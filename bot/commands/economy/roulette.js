...
module.exports = new Command({
	...
	async run(message, args) {
		...
		if (!money) return message.sendErrorReply("Error!", `Incorrect Usage. Usage: \`${message._usedPrefix}roulette <color> <amount>\``);
		if (money > moneyDB)
			return message.sendErrorReply(
				"Error!",
				`The amount you provided is more than how much money you have in your wallet. Current Balance = 🪙 **${parseInt(moneyDB)}**`,
			);
