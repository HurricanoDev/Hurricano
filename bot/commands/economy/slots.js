...
module.exports = new Command({
	...
	async run(message, args) {
		...
		let bottomEmojis = [":tangerine: :apple: :grapes:", ":grapes: :apple: :tangerine:"];
		...
		let embed = new MessageEmbed().setTitle("Slot Machine").setColor(color).addField("You spun:", emojis);
