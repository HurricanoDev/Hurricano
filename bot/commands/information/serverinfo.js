...
module.exports = new Command({
	...
	slash: {
		...
		async run(interaction, args) {
			...
			const em = new MessageEmbed()
				...
				.addField(`${emojis.categories.owner} Owner:`, (await client.users.fetch(guild.owner)).toString(), true)
	...
	async run(message, args) {
		...
		const em = new MessageEmbed()
			...
			.addField(`${emojis.categories.owner} Owner:`, (await client.users.fetch(message.guild.owner)).toString(), true)
