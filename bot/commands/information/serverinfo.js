...
module.exports = {
    ...
    run: async (message, args) => {
      ...
      const em = new MessageEmbed()
        ...
        .addField('Other', `**Youngest:** \`${newmem.user.tag}\` (${newmem.user.createdAt})\n**Oldest:** \`${oldmem.user.tag}\` (${oldmem.user.createdAt})`)
