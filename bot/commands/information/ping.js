...
module.exports = {
    ...
    run: async(message) => {
        ...
        .setAuthor("Hurricano™ Latency", "https://media.discordapp.net/attachments/803204453321670700/803930305135116288/circle-cropped_13.png")
        .setDescription("Pinging...")
        const ping = await message.channel.send(embed)
        embed
        .setDescription('')
        .setAuthor("Hurricano™", "https://media.discordapp.net/attachments/803204453321670700/803930305135116288/circle-cropped_13.png")
