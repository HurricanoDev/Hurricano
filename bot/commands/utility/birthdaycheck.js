...
module.exports = new Command({
	...
	async run(message, args) {
		...
		if (!userData.birthday) return message.sendErrorReply("Error", "Sorry! That person hasn't set their birthday yet.");

		const birthdayEmbed = new MessageEmbed()
			.setTitle("Results:")
			.setColor("RANDOM")
			.setDescription(`${user.username}'s birthdate is **${userData.birthday}**`);
