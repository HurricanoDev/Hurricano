...
module.exports = new Command({
	...
	description: "Fetches some information about a particular word specified by the user.",
	async run(message, args) {
		const text = args.join(" ");
		if (!text) return message.channel.sendError(message, "Error.", `Usage: \`${message._usedPrefix}urbandictionary <word>\``);
