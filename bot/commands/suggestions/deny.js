...
module.exports = new Command({
	...
	async run(message, args) {
		...
		if (!suggestion) return message.channel.sendError(message, "Invalid Suggestion !", "Please provide a valid suggestion !");
		...
		let embed = new MessageEmbed()
			...
			.addField(
				...
				suggestion[2].length > 1024 ? "Suggestion content is larger than 1024." : suggestion[2],
				true,
			)
