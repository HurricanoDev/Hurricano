...
export default new Command({
    ...
    async run({ message, args }) {
        ...
        //System Settings
        let systemChannel = message.guild.channels.cache.get(guildInfo.systemChannel) || "None";
        let autoRole = message.guild.roles.cache.get(guildInfo.autoRole) || "None";
        let suggestionChannel = message.guild.channels.cache.get(guildInfo.suggestionChannel) ||
            "None";
        let memberLogChannel = message.guild.channels.cache.get(guildInfo.memberLog) || "None";
        let messageLogChannel = message.guild.channels.cache.get(guildInfo.messageLogs) || "None";
        let globalChatChannel = message.guild.channels.cache.get(guildInfo.globalChatChannel) ||
            "None";
