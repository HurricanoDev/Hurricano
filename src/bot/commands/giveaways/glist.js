...
export default new Command({
    ...
    async run({ message }) {
        const embed = new MessageEmbed().setAuthor("Giveaway Lists:", "https://raw.githubusercontent.com/HurricanoBot/HurricanoImages/master/SetAuthorEmojis/Giveaway.gif");
        ...
        ${x.extraData.role == null
            ...
            return message.channel.sendError(message, "No Giveaways hosted on this server.", "No giveaways are being hosted on this server. Please host a giveaway and try this command.");
        }
    },
});
