		...
		S.fn.extend({
					...
					function (e) {
						return void 0 === e
							...
							: this.empty().each(function () {
									(1 !== nodeType && 11 !== nodeType && 9 !== nodeType) || (this.textContent = e);
							  });
					},
					null,
					e,
			...
			append: function () {
				return He(this, arguments, function (e) {
					(1 !== nodeType && 11 !== nodeType && 9 !== nodeType) || je(this, e).appendChild(e);
				});
			},
			prepend: function () {
				return He(this, arguments, function (e) {
				...
				? ((i = m(n)),
				  this.each(function (e) {
						...
						1 === nodeType &&
							...
							((r = S.valHooks[this.type] || S.valHooks[nodeName.toLowerCase()]) && "set" in r && void 0 !== r.set(this, t, "value")) ||
								(this.value = t));
				  }))
				: t
		...
		S.fn.extend({
			...
			serializeArray: function () {
				return this.map(function () {
					...
					.filter(function () {
						var e = this.type;
						return this.name && !S(this).is(":disabled") && kt.test(nodeName) && !St.test(e) && (this.checked || !pe.test(e));
					})
					.map(function (e, t) {
						var n = S(this).val();
						return null == n
